...
let randomSocial =
  socialmediacaptions[Math.floor(Math.random() * socialmediacaptions.length)];
...
let randomAbout =
  aboutcaptions[Math.floor(Math.random() * aboutcaptions.length)];
...
let randomfooterquote =
  footer_quote[Math.floor(Math.random() * footer_quote.length)];
