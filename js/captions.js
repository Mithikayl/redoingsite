...
let randomSocial =
  socialmediacaptions[Math.floor(Math.random() * socialmediacaptions.length)]; // assign random socialmediacaption
let socialPage = document.getElementById("socialcaption"); // check which page we got

if (typeof socialPage != "undefined" && socialPage != null) { // if we on the social page, fill caption
